<?php 
    ...
    $founders = [
      ["href"=>"https://www.linkedin.com/in/kees-wichard-74a2761/%20", "img"=> "kees.webp", "name"=> "KEES WICHARD", "degignatation" => "ADVISORY PARTNER", "text"=> "Kees is an experienced leader in HR technology and HR digitization with experience in different roles and industries. Kees’ key specialization is payroll transformation and integration between cloud HCM solutions and (legacy) payroll and time solutions."],
      ["href"=>"https://www.linkedin.com/in/vijay-pal-s-8767b315a/%20", "img"=> "vijay.webp", "name"=> "VIJAY PAL SINGH", "degignatation" => "CO-FOUNDER", "text"=> "Vijay is an established leader in technology and digitization with rich experience across sales, delivery and account management."],
    ];
    ...
    $news = [
      ["img"=> "newz1.png", "date"=> "november 29, 2022", "name"=> "1PHI618 UPDATES", "href"=> "/1phi618-updates"],
      ["img"=> "news2.webp", "date"=> "november 29, 2022", "name"=> "CUSTOMER UPDATES", "href"=> "/customer-updates"],
      ["img"=> "news3.webp", "date"=> "november 29, 2022", "name"=> "NEW JOINERS", "href"=> "/new-joiners"],
    ];
